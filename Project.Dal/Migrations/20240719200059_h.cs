        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShelfNo = table.Column<short>(type: "smallint", nullable: false),
                    YaratılanTarih = table.Column<DateTime>(name: "Yaratılan Tarih", type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "J.R.R Martin", new DateTime(2024, 7, 19, 23, 0, 58, 814, DateTimeKind.Local).AddTicks(6579), null, null, 1 });
